    ...
    app.RolesListView = Backbone.View.extend({
        ...
        */
        initialize : function(opts){
            ...
            this.collection.fetch({ data: {tercerointerno_id: this.parameters.dataFilter.tercerointerno_id}, reset: true });
        },
        ...
        */
        storeOne: function (data) {
            ...
            // Prepare data
            data.user_id = this.parameters.dataFilter.tercerointerno_id;
