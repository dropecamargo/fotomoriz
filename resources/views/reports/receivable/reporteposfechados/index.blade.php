...
@section('title') Reporte Cheques Posfechados @stop

@section('content')
    <section class="content-header">
		<h1>
			Reporte Cheques Posfechados
		</h1>
		<ol class="breadcrumb">
			<li><a href="{{ route('dashboard') }}"><i class="fa fa-dashboard"></i> {{ trans('app.home') }}</a></li>
			<li class="active">Reporte Cheques Posfechados</li>
		</ol>
    </section>

   	<section class="content">
	    <div class="box box-danger" id="reporte-create">
	    	<form action="{{ route('reporteposfechados.index') }}" method="GET" data-toggle="validator">
