...
class ReportePosFechadosController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
                    ...
                    case 'xls':
                        Excel::create(sprintf('%s_%s_%s', 'reporte_cheques_posfechados', date('Y_m_d'), date('H_m_s')), function($excel) use($auxiliar, $title, $type){
                            $excel->sheet('Excel', function($sheet) use($auxiliar, $title, $type){
                                $sheet->loadView('reports.receivable.reporteposfechados.reporte', compact('auxiliar', 'title', 'type'));
                                $sheet->setFontSize(8);
                            });
                        })->download('xls');
                        break;
        ...
        return view('reports.receivable.reporteposfechados.index');
    }
}
